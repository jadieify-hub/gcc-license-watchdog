# Проверка установщика GCC License Watchdog 0.1.2

Этот отчёт описывает установочные проверки версии 0.1.2. Для версии 0.1.3 проверены сборка, 52 автоматических теста и локальная страница поддержки; установка и удаление реальной службы повторно не выполнялись.
...
- версия: 0.1.2;
- тесты: 47 из 47 пройдены;
- размер установщика: 24 040 824 байта;
- SHA-256: `A0BFC5AB422550DE93123300E31CEC1BD2D7560BC8A154DF41F338E31EB66D5B`;
